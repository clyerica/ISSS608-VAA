...
The code chunk will install and launch **corrplot**, **ggpubr**, **plotly** and **tidyverse** in RStudio.
...
There are more than one way to build scatterplot matrix with R. In this section, we will create a scatterplot matrix by using the [*pairs*](https://stat.ethz.ch/R-manual/R-devel/library/graphics/html/pairs.html)function of R Graphics.
...
![](https://r4va.netlify.app/chap06_files/figure-html/unnamed-chunk-19-1.png)
